...
def text_recognition_image_rotate(image_name,east,padding,min_confidence,width, height,angle):

    image1 = rotate_image(image_name,angle)
...
image_name = "testR1.jpg"
east = "east_text_detection.pb"
padding = 0.11
min_confidence = 0.5
(height, width) = (320, 320)
angle = -90
print(text_recognition_image_rotate(image_name,east,padding,min_confidence,width, height,angle))